...
Introduction
"
**Babylonier**: 各塔には碑文があります. そこに, なぜその塔が建てられたのかを詳しく読むことができます. 例えば, ここにあります.
"
...
Statement (I : Finset ℕ) : (∑ i ∈ I, 1) = card I := by
  Hint "
    ...
    **Robo**: …$I$の要素の数, つまり$I$の濃度です.

    **Babylonier**: そして, これを証明できますか?
...
Conclusion "**Babylonier**: よくできました, これで合っています! "
