...
Introduction "あなたたちは氷の惑星に着陸しました。氷の宮殿のすぐ隣です。この宮殿を以前に見たことがあるような気がしますが, どこだったか思い出せません。

入口であなたたちを迎えるのはペンギンのような生き物です。

**グイノ**: プラドへようこそ！あなたたちが来てくれて本当に嬉しいです。初めてのお客様です！まあ, 開館したばかりですからね。さあ, 中へどうぞ！あなたたちは噂の地球人ですね？

**あなた**: ええ, そうです。あなたは...？

**グイノ**: グイノです。プラド博物館の館長です。PRIMZAHLEN-ADORATIONS博物館の！さあ, どうぞ！

グイノは入口の階段を上り, 大きなホールへと導きます。中央には小さな台が浮かんでおり, その上に2つのビー玉が置かれています。

**グイノ**: 見てください！最初の展示品です！素数「2」です！

二人とも少し困惑しています。グイノは眉を上げます。

**グイノ**: これが素数であることを証明する方法を知っていますよね？"
